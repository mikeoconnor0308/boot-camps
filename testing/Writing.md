...
The official Python documentation has a great discussion of [different types of errors that Python recognizes](https://docs.python.org/2/tutorial/errors.html).
